...
public class Game {
	...
	// Methods
	/**
	 * Construct a copy of an other game
	 * 
	 * @return The copy of the original game
	 */
	public Game copy() {
		Game copy = new Game();
	...
	/**
	 * Places the pieces corresponding to the strings stored in a content map
	 * 
	 * @param contentMap
	 *            The map you want to reproduce. Contains strings formatted like
	 *            this: "S0" where "S" is the char code corresponding to the
	 *            piece you want to place and "0" is the index of the owner of
	 *            this piece.
	 */
	...
	/**
	 * Plays the game until one of the players removes all of his opponent's
